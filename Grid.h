...
class Grid
{
	...
	Card * ClipboardCard; // This is used in copy/cut/paste card (should be set in copy/cut and got in paste)
	CoinSet * ClipboardCoinSet;
...
public:
	...
	void SetClipboardCard(Card * card);  // A setter to be used in copy/cut (in order NOT to break class responsibilities)
	Card * GetClipboardCard() const;	 // A getter to be used in paste (in order NOT to break class responsibilities)

	void SetClipboardCoinSet(CoinSet * card);  // A setter to be used in copy/cut (in order NOT to break class responsibilities)
	CoinSet * GetClipboardCoinSet() const;	 // A getter to be used in paste (in order NOT to break class responsibilities)
	...
	void SetcurrPlayerNumber(int Pnum);
...
///TODO: add any needed setter/getter "EXCEPT" ANY setters or getters of "CellList" or "PlayerList" (Forbidden for class Responsibilities)
	...
	Card* GetCardPointer(CellPosition,int);	
	...
	Card* CopyCard(CellPosition& pos);  // for copy and cut actions
	CoinSet* CopyCoinSet(CellPosition& pos); //for copy and cut actions

	// to get the cellList position
	bool IsThereACard(const CellPosition position, int &Clicked_Card_Number);
