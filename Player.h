...
class Player
{
	...
	bool prevent;                 // it is used to indicate when to move and when to add to your wallet
	int preventtimes;
	int Benefit;
...
public:
	...
	void SetturnCount(int turncount); // to be used in new game action 
	int GetTurnCount() const;		// A getter for the turnCount
	
	int GetjustRolledDiceNum() const;

	void setprevent(bool);
	bool getprevent();
	void setpreventtimes(int);
	int	 getpreventtimes();
	void setBenefit(int);
	int getBenefit();
